...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(systam_fault_LED_GPIO_Port, systam_fault_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : systam_fault_LED_Pin */
  GPIO_InitStruct.Pin = systam_fault_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(systam_fault_LED_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : Enable_Pin RS_Pin DATA4_Pin DATA5_Pin
                           DATA6_Pin DATA7_Pin ETH_CS_Pin */
